...
# head section
 ...
 echo ' 
    ...
    <head>
        ...
        <title>Nearby Grocer - Sub Categories</title>
        ...
        <div class="searchBar container">
            ...
            <div class="topcat text-center">
                <div class="catSection row">
                    ...
                    <h5 class="col-8 text-left">Sub Categories</h5>
                </div>
              
               <div class="row">
                   <div class="category col-4">
                       <a href="product.php"><img src="logo.jpg" alt="" width="100%">
                       <p>Sub Category name</p></a>
                   </div>
                   <div class="category col-4">
                        <a href="product.php"><img src="logo.jpg" alt="" width="100%">
                        <p>Sub Category name</p></a>
            ...
            <div class="catname text-center">
                ...
                <p><strong>Sub Category Name</strong></p>
