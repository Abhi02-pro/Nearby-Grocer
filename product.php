...
# head section
 ...
 echo ' 
    ...
    <head>
        ...
        <title>Nearby Grocer - Products</title>
        ...
        <div class="searchBar container">
            ...
            <div class="topcat text-center">
                <div class="catSection row">
                    <h4 class="col-8 text-left">Category Name</h4>
                    <h5 class="col-8 text-left">Sub Category Name</h5>
                    <h6 class="col-8 text-left">Products</h6>
                </div>

                <div class="product row">
                    <div class="proimg col-4">
                        <img src="logo.jpg" alt="" width="100%">
                    </div>
                    <div class="col-8">
                        <div class="row"><p><strong>"Product Name"</strong></p></div>
                        <div class="row"><p>Stock Quantity</p></div>
                        <div class="row">
